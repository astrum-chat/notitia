...
const char *zvec_doc_pk(const zvec_doc_t *doc) {
  if (doc && doc->ptr) {
    doc->pk_cache = doc->ptr->pk();
    return doc->pk_cache.c_str();
  }
  return nullptr;
}
...
zvec_status_t zvec_doc_set_bool(zvec_doc_t *doc, const char *field,
                                bool value) {
...
zvec_status_t zvec_doc_set_int64(zvec_doc_t *doc, const char *field,
                                 int64_t value) {
  return set_field_helper(doc->ptr.get(), field, value);
}

zvec_status_t zvec_doc_set_uint32(zvec_doc_t *doc, const char *field,
                                  uint32_t value) {
  return set_field_helper(doc->ptr.get(), field, value);
}

zvec_status_t zvec_doc_set_uint64(zvec_doc_t *doc, const char *field,
                                  uint64_t value) {
  return set_field_helper(doc->ptr.get(), field, value);
}
...
zvec_status_t zvec_doc_set_double(zvec_doc_t *doc, const char *field,
                                  double value) {
  return set_field_helper(doc->ptr.get(), field, value);
}
...
zvec_status_t zvec_doc_set_vector_fp32(zvec_doc_t *doc, const char *field,
...
zvec_status_t zvec_doc_set_vector_fp64(zvec_doc_t *doc, const char *field,
...
zvec_status_t zvec_doc_set_vector_int8(zvec_doc_t *doc, const char *field,
...
zvec_status_t zvec_doc_set_vector_int16(zvec_doc_t *doc, const char *field,
...
zvec_status_t zvec_doc_set_vector_int32(zvec_doc_t *doc, const char *field,
...
zvec_status_t zvec_doc_set_vector_int64(zvec_doc_t *doc, const char *field,
...
zvec_status_t
zvec_doc_set_sparse_vector_fp32(zvec_doc_t *doc, const char *field,
                                const uint32_t *indices, size_t indices_count,
                                const float *values, size_t values_count) {
  if (!doc || !doc->ptr || !field || !indices || !values ||
      indices_count != values_count) {
    zvec_status_t s;
    s.code = ZVEC_STATUS_INVALID_ARGUMENT;
    s.message = strdup("Invalid arguments");
    return s;
  ...
  doc->ptr->set(std::string(field),
                std::make_pair(std::move(idx), std::move(vals)));
  return zvec_wrapper::ok_status();
}

zvec_status_t zvec_doc_set_array_int32(zvec_doc_t *doc, const char *field,
                                       const int32_t *data, size_t len) {
  if (!doc || !doc->ptr || !field || !data) {
    zvec_status_t s;
    s.code = ZVEC_STATUS_INVALID_ARGUMENT;
...
zvec_status_t zvec_doc_set_array_int64(zvec_doc_t *doc, const char *field,
                                       const int64_t *data, size_t len) {
  if (!doc || !doc->ptr || !field || !data) {
    zvec_status_t s;
    s.code = ZVEC_STATUS_INVALID_ARGUMENT;
...
zvec_status_t zvec_doc_set_array_float(zvec_doc_t *doc, const char *field,
                                       const float *data, size_t len) {
  if (!doc || !doc->ptr || !field || !data) {
    zvec_status_t s;
    s.code = ZVEC_STATUS_INVALID_ARGUMENT;
...
zvec_status_t zvec_doc_set_array_double(zvec_doc_t *doc, const char *field,
                                        const double *data, size_t len) {
  if (!doc || !doc->ptr || !field || !data) {
    zvec_status_t s;
    s.code = ZVEC_STATUS_INVALID_ARGUMENT;
...
zvec_status_t zvec_doc_set_array_string(zvec_doc_t *doc, const char *field,
...
bool zvec_doc_get_bool(const zvec_doc_t *doc, const char *field,
                       bool *out_value) {
...
bool zvec_doc_get_int32(const zvec_doc_t *doc, const char *field,
                        int32_t *out_value) {
  if (doc && doc->ptr && field && out_value) {
...
bool zvec_doc_get_int64(const zvec_doc_t *doc, const char *field,
                        int64_t *out_value) {
  if (doc && doc->ptr && field && out_value) {
...
bool zvec_doc_get_float(const zvec_doc_t *doc, const char *field,
                        float *out_value) {
  if (doc && doc->ptr && field && out_value) {
...
bool zvec_doc_get_double(const zvec_doc_t *doc, const char *field,
                         double *out_value) {
  if (doc && doc->ptr && field && out_value) {
...
bool zvec_doc_get_string(const zvec_doc_t *doc, const char *field,
...
size_t zvec_doc_get_vector_fp32(const zvec_doc_t *doc, const char *field,
                                float *out_data, size_t max_len) {
